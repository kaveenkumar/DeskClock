...
The fonts bundled in `app/src/main/res/font/` come from [Google Fonts](https://fonts.google.com)
and are licensed under the SIL Open Font License, Version 1.1, reproduced in full below. Each
font file embeds its own copyright notice and reserved font name; the authoritative per-family
copyright statements ship inside the TTF files themselves.

| Font | Google Fonts page |
|---|---|
...
| Zen Dots | https://fonts.google.com/specimen/Zen+Dots |
...
Weather, air quality, and geocoding by [Open-Meteo](https://open-meteo.com), free for
non-commercial use ([terms](https://open-meteo.com/en/terms)).
